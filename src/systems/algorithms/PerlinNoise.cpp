...
double PerlinNoise::lin_inter(double x, double y, double s) { return x + s * (y - x); }
double PerlinNoise::smooth_inter(double x, double y, double s) { return lin_inter(x, y, s * s * (3 - 2 * s)); }
